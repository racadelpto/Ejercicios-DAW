...
public class EjemploCadenas {
	...
	public static void main(String[] args) {
		...
		System.out.println("El carácter en la posición 4 es " + texto.charAt(3));
		
		System.out.println("El carácter en la posición " + inicio + " es " + texto.charAt(inicio-1));
		...
		System.out.println("Posición de la segunda cadena en la primera: " + texto.indexOf(palabra));
	}
